...
it can be used is in the commit clause and flush-when clause of a +GROUP BY+
operation. It thus refers to the tuple that would be output shall the commit
...
tuple outputted. This is a major difference with SQL, which stops aggregating
